  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
        ...
        <div className="p-3 bg-zinc-900 border border-zinc-800 rounded-lg">
          <div className="text-[11px] font-medium text-zinc-400 uppercase tracking-wider">Log Signal</div>
          <div className="text-xl font-bold text-blue-400 mt-1">
            {(analysis.evidence_signals.logs_tfidf_signal * 100).toFixed(0)}%
          </div>
        </div>
        <div className="p-3 bg-zinc-900 border border-zinc-800 rounded-lg">
          <div className="text-[11px] font-medium text-zinc-400 uppercase tracking-wider">Bug Report Signal</div>
